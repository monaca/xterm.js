...
var Terminal = (function (_super) {
    ...
    Terminal.prototype.bindMouse = function () {
        ...
        on(el, 'mousedown', function (ev) {
            ...
            if (!_this.selectionManager.shouldForceSelection(ev)) {
                var obj = void 0;
                for (var prop in ev) {
                    obj[prop] = ev[prop];
                }
                ...
                obj.isTrusted = true;
                var newEvent = new MouseEvent(ev.type, obj);
...
},{"./AccessibilityManager":1,"./Buffer":2,"./BufferSet":3,"./CompositionHelper":6,"./EscapeSequences":7,"./EventEmitter":8,"./InputHandler":9,"./Linkifier":10,"./Parser":11,"./SelectionManager":12,"./SoundManager":14,"./Strings":15,"./Viewport":18,"./handlers/Clipboard":20,"./input/MouseZoneManager":21,"./renderer/ColorManager":23,"./renderer/Renderer":27,"./renderer/atlas/CharAtlas":31,"./shared/utils/Browser":36,"./utils/CharMeasure":37,"./utils/Clone":39,"./utils/Dom":40,"./utils/MouseHelper":41,"./utils/ScreenDprMonitor":43}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
